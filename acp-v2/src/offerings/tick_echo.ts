...
export const tickEcho: Offering = {
  name: "tick_echo",
  description:
    "Push a fixed message to your webhook every N seconds for K ticks. Subscription offering  -  pay upfront for the full tick budget. Demonstrates the ConciergeBot worker-loop + webhook + HMAC pattern end-to-end.",
