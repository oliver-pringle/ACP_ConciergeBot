...
public class SubscriptionService
{
    ...
    // Env overrides: CONCIERGEBOT_MAX_ACTIVE_GLOBAL / _PER_BUYER.
    ...
    public SubscriptionService(SubscriptionRepository subs, TickEchoRepository tickEcho, IConfiguration? cfg = null)
    {
        ...
        _maxActiveGlobal   = ResolveCap(cfg, "Subscriptions:MaxActiveGlobal",
            "CONCIERGEBOT_MAX_ACTIVE_GLOBAL", DefaultMaxActiveGlobal);
        _maxActivePerBuyer = ResolveCap(cfg, "Subscriptions:MaxActivePerBuyer",
            "CONCIERGEBOT_MAX_ACTIVE_PER_BUYER", DefaultMaxActivePerBuyer);
    }
